...
export default function Navigation() {
    ...
    return (
        <div
            ...
            <div
                className="flex justify-center items-center lg:justify-start lg:items-start w-full lg:w-1/4 font-mono"><a className="hover:text-[#08e1ec] cursor-pointer" onClick={() => redirect('/')}>&lt;brunohf.dev /&gt;</a></div>
            <div className="w-full justify-center items-center flex lg:gap-4 gap-0 lg:flex-row flex-col">
                <NavigationMenu>
                    <NavigationMenuList>
                        ...
                        <NavigationMenuLink onClick={() => redirect('/portfolio')}
